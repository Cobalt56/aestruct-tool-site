...
const ProductContact: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    company: '',
    interest: 'Buying Full License (Pro Tools)',
    message: ''
  });
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        {/* Left Column: Context */}
        <div>
          <h1 className="text-4xl font-serif font-bold text-white mb-6">Get The Full Tool Suite</h1>
          <p className="text-xl text-ae-muted mb-10 leading-relaxed">
            Ready to upgrade from the demo? We provide enterprise-grade licensing and implementation support for all our Pro tools.
          </p>
          ...
          <div className="space-y-8">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Sales Inquiries</h3>
            ...
            <div className="bg-ae-card/50 border border-ae-accent/20 rounded-xl p-6 mt-12">
              <h3 className="font-serif text-xl font-bold text-white mb-2">Implementation Process</h3>
              <ol className="space-y-4 text-ae-muted text-sm mt-4">
                <li className="flex gap-3">
                  <span className="font-bold text-ae-accent">01</span>
                  <span>License Selection & Customization</span>
                </li>
                <li className="flex gap-3">
        ...
        <div className="bg-ae-card border border-white/5 rounded-2xl p-8 shadow-xl">
          {status === 'success' ? (
            <div className="h-full flex flex-col items-center justify-center text-center py-12 animate-in fade-in duration-500">
              ...
              <h3 className="text-2xl font-serif font-bold text-white mb-4">Request Received</h3>
              <p className="text-ae-muted mb-8 max-w-md">
                Thank you for your interest. A member of our sales engineering team will contact you within 24 hours to discuss licensing.
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <h2 className="text-2xl font-bold text-white mb-6">Product Inquiry</h2>
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="text-sm font-medium text-ae-muted">Details regarding your needs</label>
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full bg-ae-dark border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-white focus:ring-2 focus:ring-ae-accent focus:border-transparent"
                    placeholder="Which tools are you interested in?"
                  />
                </div>
              </div>
              ...
              >
                {status === 'submitting' ? 'Sending...' : 'Request Full Version of Product and Consultation'} <Send className="ml-2 w-4 h-4" />
              </Button>
            </form>
          )}
        </div>
